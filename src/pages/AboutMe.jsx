...
export default function AboutMe() {
    return (
        <>
            <div className="md:container 2xl:w-2/3 xl:w-3/4 l:w-1/4 p-8 md:p-16 m-8 mx-auto bg-light-2 md:rounded-xl shadow-sm">

                <img src="./src/assets/photo.png" alt="Portrait photo" className="xl:w-1/4 md:w-1/3 sm:w-1/2 rounded-full shadow-lg mx-auto" />

                <p className="md:px-16 pt-8 font-secondary text-xl">Lorem, ipsum dolor sit amet consectetur adipisicing elit. Dolores amet illum id corrupti veniam! Magni eos obcaecati dolores natus blanditiis odio. Delectus nihil quas eligendi a, placeat voluptatum vitae nostrum!
